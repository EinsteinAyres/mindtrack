...
public class UserController {
    ...
    @GetMapping("/")
    public ResponseEntity<Page<UserResponseDto>> buscaTodosUsuarios(Pageable pageable) {
        // Delega a busca por todos para o Serviço e usa o status 200 OK
        Page<UserResponseDto> page = userService.buscaTodosUsuarios(pageable);
